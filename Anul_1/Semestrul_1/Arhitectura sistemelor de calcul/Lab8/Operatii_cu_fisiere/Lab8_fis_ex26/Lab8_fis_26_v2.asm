; oprim executia la intalnirea caracterului '$', chiar daca se afla in interiorul unui cuvant (ex, '$Ana', 'me$re', 'pere$') - cuvantul nu este luat deloc in considerare
...
segment code use32 class=code
    start:
        ...
        repeta:
            ...
            ; verificam daca exista caracterul '$' in cuvant
            cld
            mov esi, n
            mov ecx, 50
            repeta2:
