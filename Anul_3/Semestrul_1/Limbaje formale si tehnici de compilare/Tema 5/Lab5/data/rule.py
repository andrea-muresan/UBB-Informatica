...
class RuleComponent:
    """
    Represents a component of a grammar rule.
    A component can be either a terminal or a non-terminal symbol.
    """
...
class RuleTerminal(RuleComponent):
    """
    Represents a terminal symbol in a grammar rule.
    A terminal is a symbol that cannot be replaced further during parsing.
    """
...
class RuleNonTerminal(RuleComponent):
    """
   Represents a non-terminal symbol in a grammar rule.
   A non-terminal is a symbol that can be replaced with other symbols during parsing.
   """
    def __init__(self, value: str):
...
class Rule:
    """
    Represents a production rule in a grammar. A rule consists of a left-hand side (LHS)
    and a right-hand side (RHS) which can contain terminals and non-terminals.
    """
